...
const EditContentForm = () => {
  return (
    <div className="w-full sm:w-[430px] bg-white px-2 py-2 pb-3 flex items-center justify-center flex-col gap-3 rounded-md shadow-lg">
      ...
      <h1 className="text-xl uppercase font-bold text-blue-600">Update Topic</h1>
      <form className="w-full flex items-center flex-col gap-2">
        ...
        <input
          ...
          required
        />
        <button className="w-full sm:w-[120px] bg-blue-700 p-2 text-white font-bold rounded-md hover:bg-blue-600 mt-2">
          Update Task
        </button>
      </form>
    </div>
